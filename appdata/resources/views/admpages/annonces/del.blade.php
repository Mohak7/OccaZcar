    ...
    <div class="col-md-12">
        <div class="content-panel">
            <table class="table table-striped table-advance table-hover">
                ...
                <thead>
                <tr>
                    <th><i class="fa fa-bullhorn"></i> Code annonce</th>
                ...
                @forelse ($annonce  as $liste)
                    <tr>
                        ...
                        <td>
                            <form action="{{route('deletecompleteannonce',$liste->id)}}" method="post" class='form-inline'>
                                @csrf
                                @method('DELETE')
                                <a href="{{route('restoreannonce',$liste->id)}}" class="btn btn-warning btn-xs"><i class="fa fa-trash"></i></a>
